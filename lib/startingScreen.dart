  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      floatingActionButton: FloatingActionButton(onPressed: (){
        ...
        child: Icon(FlutterIcons.play_circle_faw5,color: Colors.white,),
        ...
        children: <Widget>[
          ClipPath(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(image: AssetImage("images/img2.png"),fit: BoxFit.cover),
            ),
            ),
          ),
          Padding(
            ...
            child: Align(
              alignment: Alignment.topCenter,
                child: Text("$_start",style: TextStyle(fontWeight: FontWeight.w900,fontSize: 50),)),
          ),
          Stack(
            children: <Widget>[
              Align(
